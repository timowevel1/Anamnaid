            ...
            if (err) {
                ...
                if (rows[0]) {
                    ...
                    Password.verifyPassword(rows[0].password, req.body.password).then(async result => {
                        ...
                        } else res.send(403); //If provided password doesnt match the password to the provided email address
                    })
                } else res.sendStatus(404); //User with provided email doesnt exist
            }
        });
    }
